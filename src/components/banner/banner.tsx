...
export default function Banner() {
  return (
    <div className="text-primary-content flex h-[600px] flex-col items-center justify-between gap-8 rounded-2xl bg-[#6782fb] p-6 sm:p-14 md:flex-row md:gap-12">
      <div className="flex-1 text-center md:text-left">
        <h2 className="mb-2 text-2xl font-bold text-[#0a0047] sm:text-6xl">
          Explore os materiais Acadêmicos
        </h2>
        <p className="mb-4 text-xl text-[#0a0047] opacity-90 sm:text-4xl">
